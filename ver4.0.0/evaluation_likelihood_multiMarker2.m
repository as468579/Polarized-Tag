...
%             );
            ...
            hold on;
            plot(grid3by3Position(2, :), grid3by3Position(1, :), 'r.', 'MarkerSize', 30);
            text(weighted_particles(2), weighted_particles(1), strcat('id = ',num2str(ID(size(ID,2)))),'FontSize',20,'Color','w','HorizontalAlignment', 'right');
            drawnow;
            hold off
        end
    end
